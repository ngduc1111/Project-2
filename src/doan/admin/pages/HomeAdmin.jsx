      ...
      <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{ width: "280px", border: "double", borderRadius: "10px" }}>
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          ...
          <li>
              ...
              <Link to={"/admin/themSp"}><strong className='strong' style={{ color: "black", marginLeft:"29px", padding:"5px" }}>Sản Phẩm</strong></Link>
           
          </li>
          <li>
          
              <Link to={"/admin/sp"}><strong className='strong' style={{ color: "black", marginLeft:"33px" }}>Chi Tiết</strong></Link>
        ...
        <div className='col-md-4'>
          <div className="card" style={{ width: "18rem" }}>
            <div style={{ borderRadius: "20px" }} className="card-body bg-success">
              ...
              <p className="card-text"><h3 style={{ color: "white", textAlign: "center" }}><strong>+ 201K</strong></h3></p>
            </div>
          </div>
        </div>
        <div className='col-md-4'>
          <div className="card" style={{ width: "18rem" }}>
            <div style={{ borderRadius: "20px" }} className="card-body bg-warning">
              ...
              <p className="card-text"><h3 style={{ color: "white", textAlign: "center" }}><strong>18K</strong></h3></p>
            </div>
          </div>
        </div>
        <div className='col-md-4'>
